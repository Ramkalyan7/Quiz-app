...
export default function LobbyPage() {
  ...
  const { players, userId, isHost ,loading,setLoading} = useCompete();
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
              ...
              {players.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <p className="text-gray-600 font-medium text-lg">Waiting for players to join...</p>
                ...
                <div className="mt-8 p-5 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border-2 border-blue-200">
                  <div className="flex items-center gap-2 mb-3">
                    <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-1.657-1.343-3-3-3s-3 1.343-3 3 1.343 3 3 3c.518 0 1.002-.114 1.447-.316L9 17h6a2 2 0 012 2v1m-8-8V5a2 2 0 012-2h6a2 2 0 012 2v12a2 2 0 01-2 2h-6a2 2 0 01-2-2v-4" />
                    </svg>
                    <p className="text-sm text-blue-900 font-semibold">Invite More Friends</p>
                  </div>
          ...
          <div className="lg:col-span-1">
            ...
            {!isConnected && (
              <div className="mb-6 bg-yellow-50 border-l-4 border-yellow-500 rounded-r-xl p-4 shadow-md">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-yellow-600 flex-shrink-0 mt-0.5 animate-pulse" fill="currentColor" viewBox="0 0 20 20">
            ...
            {isHost ? (
              <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl shadow-xl p-8 text-white space-y-6 sticky top-24">
                <div>
                  <div className="inline-flex items-center gap-2 mb-2">
                    ...
                    <p className="text-sm opacity-90 font-medium">You're the host</p>
                  </div>
              ...
              <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl shadow-xl p-8 text-white space-y-6 sticky top-24">
                ...
                <div className="bg-white/10 rounded-lg p-4 backdrop-blur border border-white/20">
                  <p className="text-sm opacity-90 mb-3 font-medium">Players in Lobby:</p>
                ...
                <div className="flex flex-col items-center gap-3 py-4">
                  ...
                  <p className="text-sm opacity-90 text-center">Waiting for host to start the quiz...</p>
                </div>
