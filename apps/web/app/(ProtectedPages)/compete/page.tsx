    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 px-4 sm:px-6 lg:px-8 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl font-bold text-gray-900 mb-3">Multiplayer Quiz</h1>
          <p className="text-xl text-gray-600">Create or join a quiz to compete with friends!</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl shadow-xl border border-purple-300 p-10 text-white hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
            ...
            <p className="text-white/90 mb-8 leading-relaxed">
              Create a new AI-powered quiz on any topic and share the room code with your friends to compete together in real-time!
            </p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Instant questions on any topic</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-2xl">📊</span>
                <div>
                  ...
                  <p className="text-sm text-white/80">Start the quiz whenever you're ready</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-2xl">👥</span>
                <div>
                  ...
                  <p className="text-sm text-white/80">Share your unique room code</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-10 hover:shadow-2xl transition-all duration-300">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-3">Join a Quiz</h2>
            <p className="text-gray-600 mb-8">
              Enter the room code your friend shared and join the competitive quiz in real-time!
            </p>
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-2">Ask your friend for the room code</p>
              </div>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 border border-gray-200 text-center shadow-md hover:shadow-lg transition-all duration-300">
            ...
            <p className="text-sm text-gray-600">Live scoring and instant leaderboard updates</p>
          </div>

          <div className="bg-white rounded-xl p-6 border border-gray-200 text-center shadow-md hover:shadow-lg transition-all duration-300">
            <div className="text-4xl mb-3">🏆</div>
            <h3 className="font-bold text-gray-900 mb-2">Competitive</h3>
            <p className="text-sm text-gray-600">Speed and accuracy combined scoring system</p>
          </div>

          <div className="bg-white rounded-xl p-6 border border-gray-200 text-center shadow-md hover:shadow-lg transition-all duration-300">
            <div className="text-4xl mb-3">👥</div>
            <h3 className="font-bold text-gray-900 mb-2">Multiplayer</h3>
            <p className="text-sm text-gray-600">Compete with unlimited friends seamlessly</p>
          </div>
        </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-2xl shadow-xl p-8 text-white text-center">
          ...
          <p className="text-lg opacity-90 mb-6">
            Choose your role: Host a new quiz or join your friend's room to start competing now!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="px-8 py-3 bg-white/20 text-white font-bold rounded-lg hover:bg-white/30 border border-white transition-all duration-300 backdrop-blur">
              Learn More
            </button>
          </div>
        </div>
